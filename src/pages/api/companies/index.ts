...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const { name, website, careersUrl, description, location, categoryId } = parsed.data;
    ...
    const [created] = await db
      .insert(companies)
      .values({ name, slug, website: website || null, careersUrl: careersUrl || null, description: description || null, location: location || null, categoryId })
