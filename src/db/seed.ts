...
const seedStages = [
  "Postulación Enviada",
  "Primera Entrevista (HR)",
  "Evaluación o Prueba Práctica",
  "Entrevista Final (Hiring Manager)",
  "Oferta Laboral",
  "Proceso Finalizado",
].map((name) => ({ name, slug: slugify(name) }));
...
const seedCompanies = [
  ...
  { name: "Codelco", categorySlug: "mineria", location: "Santiago, Chile", description: "Empresa estatal de cobre y la mayor productora del metal a nivel mundial, con faenas a lo largo de todo Chile." },
  ...
  { name: "LATAM Airlines", categorySlug: "transporte-y-logistica", location: "Santiago, Chile", description: "Grupo de aerolíneas líder en Sudamérica, conectando más de 140 destinos en el continente." },
  { name: "Banco de Chile", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Banco tradicional chileno con amplia red de sucursales y foco en banca de personas y empresas." },
  { name: "Banco Santander", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Uno de los bancos más grandes del país, con una fuerte apuesta por la digitalización." },
  { name: "BCI", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Banco chileno fundado en 1937 con presencia en banca personal, empresas y medios de pago." },
  { name: "Mercado Libre", categorySlug: "tecnologia", location: "Santiago, Chile", description: "Plataforma líder de e-commerce y fintech de América Latina, con un fuerte hub de ingeniería local." },
  { name: "Falabella", categorySlug: "retail", location: "Santiago, Chile", description: "Multitienda y ecosistema financiero, uno de los retailers más grandes de Latinoamérica." },
  ...
  { name: "Entel", categorySlug: "telecomunicaciones", location: "Santiago, Chile", description: "Empresa de telecomunicaciones móviles e internet, líder en conectividad en Chile y Perú." },
  ...
  { name: "Banco Estado", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Banco estatal con la mayor cobertura del país y foco en inclusión financiera." },
  { name: "Itaú Chile", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Parte del grupo Itaú Unibanco, con una operación enfocada en banca corporativa y de inversiones." },
  ...
  { name: "SKY Airline", categorySlug: "transporte-y-logistica", location: "Santiago, Chile", description: "Aerolínea low cost chilena con operaciones nacionales e internacionales." },
  ...
  { name: "Metro de Santiago", categorySlug: "transporte-y-logistica", location: "Santiago, Chile", description: "Empresa de transporte público ferroviario que moviliza a millones de pasajeros a diario." },
  ...
  { name: "Agrosuper", categorySlug: "alimentos-y-bebidas", location: "Rancagua, Chile", description: "Productora de alimentos del rubro proteico (pollo, cerdo y salmón) con operaciones nacionales." },
  ...
  { name: "WOM", categorySlug: "telecomunicaciones", location: "Santiago, Chile", description: "Operador móvil challenger con foco en precios competitivos y cobertura nacional." },
  ...
  { name: "Enel Chile", categorySlug: "energia", location: "Santiago, Chile", description: "Generadora y distribuidora de energía del grupo Enel, líder en energías renovables." },
  ...
  { name: "Duoc UC", categorySlug: "educacion", location: "Santiago, Chile", description: "Institución de educación superior técnica con sedes a lo largo de todo el país." },
...
const seedReviews: SeedReview[] = [
  {
    ...
    stages: [
      ...
      {
        stageSlug: "primera-entrevista-hr",
  ...
  },
  {
    ...
    stages: [
      ...
      {
        stageSlug: "entrevista-final-hiring-manager",
...
async function seed() {
  ...
  for (const company of seedCompanies) {
    ...
    await db
      .insert(companies)
      .values({ name: company.name, slug: company.slug, description: company.description, location: company.location, categoryId })
      .onConflictDoUpdate({
        target: companies.slug,
        set: { name: company.name, description: company.description, location: company.location, categoryId },
      });
  }
