...
const seedCompanies: SeededCompany[] = [
  { name: "Antofagasta Minerals", categorySlug: "mineria", location: "Antofagasta, Chile", description: "Compañía minera de cobre con operaciones en el norte de Chile, líder en la región de Antofagasta.", website: "https://www.aminerals.cl", careersUrl: "https://www.aminerals.cl/trabaja-con-nosotros" },
  ...
  { name: "Anglo American", categorySlug: "mineria", location: "Santiago, Chile", description: "Minería diversificada con operaciones de cobre y la planta de procesamiento de Los Bronces.", website: "https://www.angloamerican.com", careersUrl: "https://careers.angloamerican.com" },
  { name: "BHP", categorySlug: "mineria", location: "Santiago, Chile", description: "Gigante minero global con faenas como Escondida y Cerro Colorado en Chile.", website: "https://www.bhp.com", careersUrl: "https://careers.bhp.com" },
  { name: "SQM", categorySlug: "mineria", location: "Santiago, Chile", description: "Compañía chilena de litio, yodo y fertilizantes especiales, líder mundial en el Salar de Atacama.", website: "https://www.sqm.com", careersUrl: "https://sqm.trabajando.cl" },
  ...
  { name: "Cencosud", categorySlug: "retail", location: "Santiago, Chile", description: "Conglomerado de retail con supermercados, tiendas por departamento y centros comerciales.", website: "https://www.cencosud.com", careersUrl: "https://empleos.cencosud.com" },
  ...
  { name: "Nestlé", categorySlug: "alimentos-y-bebidas", location: "Santiago, Chile", description: "Multinacional de alimentos con plantas en Chile y un amplio portafolio de marcas.", website: "https://www.nestle.cl" },
  { name: "Coca-Cola", categorySlug: "alimentos-y-bebidas", location: "Santiago, Chile", description: "Compañía de bebidas con operación y embotellado en todo el territorio chileno.", website: "https://www.koandina.com", careersUrl: "https://www.koandina.com/trabaja-con-nosotros" },
  { name: "CCU", categorySlug: "alimentos-y-bebidas", location: "Santiago, Chile", description: "Compañía de cervezas, vinos, aguas y bebidas con una fuerte presencia local.", website: "https://www.ccu.cl", careersUrl: "https://www.trabajaenccu.cl" },
  { name: "Procter & Gamble", categorySlug: "consumo-masivo", location: "Santiago, Chile", description: "Multinacional de consumo masivo con marcas líderes en higiene y cuidado personal.", website: "https://www.pg.com/es_LA", careersUrl: "https://www.pgcareers.com" },
  { name: "Sigdo Koppers", categorySlug: "manufactura", location: "Santiago, Chile", description: "Grupo industrial y de servicios con foco en manufactura y construcción.", website: "https://www.sigdokoppers.cl" },
  { name: "Viña Concha y Toro", categorySlug: "alimentos-y-bebidas", location: "Pirque, Chile", description: "La viña más grande de Chile y una de las mayores del mundo en vinos.", website: "https://www.conchaytoro.com", careersUrl: "https://conchaytoro.trabajando.cl" },
  { name: "Sodimac", categorySlug: "retail", location: "Santiago, Chile", description: "Cadena de mejoramiento del hogar y construcción del grupo Falabella.", website: "https://www.sodimac.falabella.com", careersUrl: "https://sodimac.trabajando.cl" },
  { name: "Microsoft Chile", categorySlug: "tecnologia", location: "Santiago, Chile", description: "Filial chilena del gigante tecnológico, con foco en nube, IA y transformación digital.", website: "https://www.microsoft.com/es-cl", careersUrl: "https://careers.microsoft.com" },
  ...
  { name: "Scotiabank Chile", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Banco canadiense con fuerte presencia en retail banking y grandes empresas en Chile.", website: "https://www.scotiabankchile.cl" },
  { name: "Banco BICE", categorySlug: "banca-y-finanzas", location: "Santiago, Chile", description: "Banco chileno especializado en banca de empresas y crédito corporativo.", website: "https://www.bice.cl", careersUrl: "https://bice.trabajando.cl" },
  { name: "Ripley", categorySlug: "retail", location: "Santiago, Chile", description: "Multitienda y banco con presencia física y e-commerce en Chile y Perú.", website: "https://www.ripley.cl" },
  { name: "Paris", categorySlug: "retail", location: "Santiago, Chile", description: "Tienda por departamento del grupo Cencosud, con una fuerte operación online.", website: "https://www.paris.cl" },
  { name: "Globant", categorySlug: "tecnologia", location: "Santiago, Chile", description: "Multinacional de servicios tecnológicos y transformación digital, con un centro en Santiago.", website: "https://www.globant.com", careersUrl: "https://www.globant.com/careers" },
  { name: "NTT Data", categorySlug: "tecnologia", location: "Santiago, Chile", description: "Consultora global de TI y servicios de transformación digital con oficinas en Chile.", website: "https://www.nttdata.com", careersUrl: "https://www.nttdata.com/global/en/careers" },
  ...
  { name: "JetSMART", categorySlug: "transporte-y-logistica", location: "Santiago, Chile", description: "Aerolínea de bajo costo con base en Santiago y rutas a lo largo de Sudamérica.", website: "https://www.jetsmart.com" },
  ...
  { name: "Turbus", categorySlug: "transporte-y-logistica", location: "Santiago, Chile", description: "Empresa de transporte interurbano de pasajeros, la más grande del país.", website: "https://www.turbus.cl" },
  ...
  { name: "Carozzi", categorySlug: "alimentos-y-bebidas", location: "Santiago, Chile", description: "Multinacional de alimentos con marcas líderes en pastas, galletas y dulces.", website: "https://www.carozzi.cl", careersUrl: "https://carozzi.trabajando.cl" },
  { name: "Viña Santa Rita", categorySlug: "alimentos-y-bebidas", location: "Buin, Chile", description: "Viña chilena con más de 140 años de tradición y exportación a más de 70 países.", website: "https://www.santarita.com", careersUrl: "https://santarita.trabajando.cl" },
  ...
  { name: "Movistar Chile", categorySlug: "telecomunicaciones", location: "Santiago, Chile", description: "Operador de telecomunicaciones del grupo Telefónica, con servicios móviles y fijos.", website: "https://www.movistar.cl", careersUrl: "https://jobs.telefonica.com/?locale=es_ES" },
  { name: "Claro Chile", categorySlug: "telecomunicaciones", location: "Santiago, Chile", description: "Operador móvil del grupo América Móvil con cobertura a lo largo de todo Chile.", website: "https://www.clarochile.cl", careersUrl: "https://clarochile.trabajando.cl" },
  ...
  { name: "Colbún", categorySlug: "energia", location: "Santiago, Chile", description: "Generadora de energía eléctrica con un mix hídrico, térmico y renovable.", website: "https://www.colbun.cl", careersUrl: "https://www.colbun.cl/corporativo/trabajadores/trabaja-en-colbun" },
  { name: "ENAP", categorySlug: "energia", location: "Valparaíso, Chile", description: "Empresa Nacional del Petróleo, dedicada a la exploración, producción y refinación de hidrocarburos.", website: "https://www.enap.cl", careersUrl: "https://enap.trabajando.cl" },
  { name: "Cruz Verde", categorySlug: "salud", location: "Santiago, Chile", description: "Cadena de farmacias con cobertura nacional y servicios de salud digital.", website: "https://www.cruzverde.cl", careersUrl: "https://www.cruzverde.cl/trabaja-con-nosotros" },
  { name: "RedSalud", categorySlug: "salud", location: "Santiago, Chile", description: "Red de clínicas y prestadores de salud con presencia en varias regiones del país.", website: "https://www.redsalud.cl", careersUrl: "https://redsalud.trabajando.cl" },
  { name: "Deloitte", categorySlug: "consultoria", location: "Santiago, Chile", description: "Firma global de auditoría, consultoría y asesoría financiera.", website: "https://www.deloitte.com/cl/es", careersUrl: "https://www.deloitte.com/cl/es/careers.html" },
  { name: "EY", categorySlug: "consultoria", location: "Santiago, Chile", description: "Firma global de auditoría y consultoría con oficinas en Santiago.", website: "https://www.ey.com/es_cl", careersUrl: "https://www.ey.com/es_cl/careers" },
  { name: "CMPC", categorySlug: "manufactura", location: "Santiago, Chile", description: "Grupo forestal y papelero, uno de los mayores del mundo en celulosa.", website: "https://www.cmpc.com", careersUrl: "https://www.cmpc.com/trabaja-con-nosotros" },
  { name: "Arauco", categorySlug: "manufactura", location: "Santiago, Chile", description: "División forestal de Empresas Copec, líder en celulosa y productos de madera.", website: "https://www.arauco.com", careersUrl: "https://careers.arauco.com" },
  { name: "CAP", categorySlug: "manufactura", location: "Santiago, Chile", description: "Grupo minero-siderúrgico que produce acero y productos de la minería del hierro.", website: "https://www.cap.cl" },
  { name: "Salfacorp", categorySlug: "construccion-e-inmobiliaria", location: "Santiago, Chile", description: "Grupo de ingeniería y construcción con proyectos en Chile, Perú y Colombia.", website: "https://www.salfacorp.com" },
  { name: "Besalco", categorySlug: "construccion-e-inmobiliaria", location: "Santiago, Chile", description: "Empresa de construcción e ingeniería con más de 75 años de historia.", website: "https://www.besalco.cl" },
  { name: "CineHoyts", categorySlug: "entretenimiento-y-medios", location: "Santiago, Chile", description: "Cadena de cines líder en Chile, parte del grupo Cinemark.", website: "https://cinehoyts.cl" },
  { name: "Mega", categorySlug: "entretenimiento-y-medios", location: "Santiago, Chile", description: "Canal de televisión chileno, líder en audiencia a nivel nacional.", website: "https://www.mega.cl", careersUrl: "https://mega.trabajando.cl" },
  ...
  { name: "Universidad de los Andes", categorySlug: "educacion", location: "Santiago, Chile", description: "Universidad privada chilena con foco en investigación y docencia.", website: "https://www.uandes.cl", careersUrl: "https://uandes.trabajando.cl" },
